export const CATEGORY = {
  all:   { label: "All",       color: "#D76B3F", soft: "#FFE3D2", emoji: "✨" },
  video: { label: "Videos",    color: "#2DB89E", soft: "#D4F1EA", emoji: "🎬" },
  audio: { label: "Audio",     color: "#7A5BC9", soft: "#E8DFFF", emoji: "🎵" },
  doc:   { label: "Documents", color: "#E89B1C", soft: "#FFE9C2", emoji: "📄" },
  game:  { label: "Games",     color: "#E84B6B", soft: "#FFD8E1", emoji: "🎮" },
} as const
...
export const RESOURCES: Resource[] = [
  ...
  { id:"a1", kind:"audio", title:"Songs for Speech Day", desc:"Three sing-along tracks for warming up the voice.", duration:"3:42", tags:["Music","Listening"], badge:"Calm", age:"Preschool", service:"Speech therapy", fav:true, thumbBg:"#E8DFFF", thumbEmoji:"🎵" },
  ...
  { id:"d1", kind:"doc", title:"Daily Practice Worksheet", desc:"Printable mouth-shape & sound practice sheet.", pages:4, tags:["Articulation","Printable"], badge:"PDF", age:"Middle School", service:"Occupational therapy", fav:true, thumbBg:"#FFF3D6", thumbEmoji:"📝" },
  ...
  { id:"g2", kind:"game", title:"Puzzle Pop", desc:"Tap matching shapes. Stages get bigger as the child masters each grid.", plays:"980", tags:["Memory","Vocabulary"], badge:"Multi-Stage", age:"Adult", service:"Physical therapy", fav:true, thumbBg:"#FFD8E1", thumbEmoji:"🧩" },
